...
/*   Updated: 2024/09/19 13:20:30 by miheider         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Fixed& Fixed::operator++() {
	// std::cout << "preincrement operator (Fixed) called" << std::endl;
	_fixed_point_number += 1;
	return *this;
}

Fixed& Fixed::operator--() {
	// std::cout << "predecrement operator (Fixed) called" << std::endl;
	_fixed_point_number -= 1;
	return *this;
}

Fixed Fixed::operator++(int) {
	// std::cout << "postincrement operator (Fixed) called" << std::endl;
	Fixed save = *this;
...
Fixed   Fixed::operator--(int) {
	// std::cout << "postdecrement operator (Fixed) called" << std::endl;
	Fixed save = *this;
